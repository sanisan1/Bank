...
## Вклад в проект
Проект разработан как демонстрация навыков программирования на Java с использованием современных технологий Spring Framework. Включает в себя полную реализацию банковской системы с учетом бизнес-требований и лучших практик разработки.
